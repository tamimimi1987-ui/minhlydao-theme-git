<?php
/**
 * Bài Tin tức — giống single.php nhưng có thêm cột "Tin mới nhất" bên phải
 * và khối "Tin tức liên quan" bên dưới nội dung (đúng như site gốc).
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }
get_header();
while ( have_posts() ) : the_post();
	$src = get_post_meta( get_the_ID(), '_mld_news_source_url', true );
?>
...
<div class="content-with-sidebar wrap">
	<article class="content-area">
		...
		<?php if ( $src ) : ?>
			<p style="margin-top:24px"><a class="btn" href="<?php echo esc_url( $src ); ?>" target="_blank" rel="noopener">Xem bài gốc</a></p>
		<?php endif; ?>
